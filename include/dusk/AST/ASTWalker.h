...
namespace dusk {
    ...
    ///
    /// \description \c ASTWalker provides default API for walking the AST.
    ///  The API consists of \c postWalk and \c preWalk methods.
    class ASTWalker {
    public:
        ASTWalker() = default;
        ...
        ///
        /// \return \c true if the node should be walked, false otherwise.
